...
export const GptMessageSelectableImage = ({ imageUrl, onImageSelected }: Props) => {
    ...
    // useEffect se dispara en cuanto el componente se monte
    useEffect(() => {
    ...
    /*
        Funciones canvas
        https://gist.githubusercontent.com/Klerith/1626d61141af484739ecbcc349a11789/raw/de21323c76427551f1778906418157dbfff1be02/funciones-canvas.ts
    */


        // Se dispara cuando hacemos clic con el botón
        const onMouseDown = (
          ...
          // Cuando la persona suelta el clic
          // El espacio donde queremos editar
          const onMouseUp = () => {
            setIsDrawing(false);
            const canvas = canvasRef.current!;1111
    ...
    <div className="col-start-1 col-end-9 p-3 rounded-lg">
        <div className="flex flex-row items-start">
            <div className="flex justify-center items-center h-10 w-10 rounded-full bg-green-600 flex-shrink-0">
                G
            </div>
            <div className="relative ml-3 text-sm bg-black bg-opacity-25 pt-3 pb-2 px-4 
            shadow rounded-xl">
