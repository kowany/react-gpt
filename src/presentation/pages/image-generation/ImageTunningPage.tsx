...
import { GptMessageSelectableImage, GptMessages, MyMessage, TextMessageBox, TypingLoader } from "../../components";
...
export const ImageTunningPage = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      info: {
        alt: 'Imagen base',
        imageUrl: 'http://localhost:3000/gpt/image-generation/1718380781061.png'
      }
    }
  ])
  ...
  const handlePost = async (text: string) => {
    ...
    if (!imageInfo) {
      return setMessages((prev) => [...prev, {text: 'No se pudo generar la image', isGpt: true}]);
    }
        ...
        originalImageAndMask.original && (
          <div className="fixed flex flex-col items-center top-10 right-10 z-10 fade-in">
            ...
            <img
              ...
              alt="Imagen original"
            />
            <button onClick={ handleVariaion } className="btn-primary mt-2">Generar variación</button>
          </div>
        )
      }
